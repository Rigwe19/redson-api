...
export class AdminController {
  ...
  @Returns(200, Array)
  async getUsers() {
    // Assuming usersService.findAll is updated to support pagination
    // and returns an object like { users: User[], total: number }
  ...
  @Returns(200, Array)
  async updateUser(@PathParams("id") id: string, @BodyParams() user: any) {
